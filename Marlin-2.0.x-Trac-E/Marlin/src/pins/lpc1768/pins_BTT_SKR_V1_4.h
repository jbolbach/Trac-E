...
//
  ...
  #define POWER_LOSS_PIN                   P1_28  // PWRDET
#endif
...
//
  ...
  #define X2_SERIAL_TX_PIN                 P1_09
  #define X2_SERIAL_RX_PIN                 P1_09

  #define Y_SERIAL_TX_PIN                  P1_08
  #define Y_SERIAL_RX_PIN                  P1_08

  #define Z_SERIAL_TX_PIN                  P1_04
  #define Z_SERIAL_RX_PIN                  P1_04

  #define Z2_SERIAL_TX_PIN                 P1_01
  #define Z2_SERIAL_RX_PIN                 P1_01

  #define E0_SERIAL_TX_PIN                 P4_29
  #define E0_SERIAL_RX_PIN                 P4_29

  #define E1_SERIAL_TX_PIN                 P4_29
  #define E1_SERIAL_RX_PIN                 P4_29
 ...
 */
    ...
    //#define LCD_SDSS                       P0_00  // (16) J3-7 & AUX-4
