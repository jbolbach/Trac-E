 ...
 * this offset is applied to the 22 motor. To find the offset home the X axis, and measure the error
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {50, Y_BED_SIZE/2}, {X_BED_SIZE-50,  Y_BED_SIZE/2 }}
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { 50, Y_BED_SIZE/2 }, { X_BED_SIZE-50, Y_BED_SIZE/2 } }
  #else
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  50, 50 }, { X_BED_SIZE-50,  50 }, { X_BED_SIZE-50, Y_BED_SIZE-50 }, { 50, Y_BED_SIZE-50 } }
